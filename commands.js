  ...
  forms: {
    ...
    async execute(interaction) {
      let formEmbed = new EmbedBuilder()
        ...
        .setDescription('Use the suggestion form if you would like to request new games for the society to purchase. You can still leave ideas in <#834077673411444776> too\n\nUse the welfare form if you would like to leave a complaint about someone\'s behaviour.');
      ...
      let actions = new ActionRowBuilder()
        .addComponents(suggestButton, welfareButton);
  ...
  help: {
    ...
    async execute(interaction, client) {
      ...
      let helpEmbed = new EmbedBuilder()
        ...
        .setColor(0xf542e3);
      names.forEach(name => helpEmbed.addFields({
  ...
  roll: {
    command: new SlashCommandBuilder()
      ...
      .addStringOption(option =>
        option.setName('dice')
          .setDescription('What to roll, e.g. 2d8+4'))
